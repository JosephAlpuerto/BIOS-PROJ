<%@ Page Title="" Language="C#" MasterPageFile="~/Warehouse.Master" AutoEventWireup="true" CodeBehind="Warehouse-InquiryForm.aspx.cs" Inherits="BIOSproject.Warehouse_InquiryForm" %>
   ...
   <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    ...
    <asp:GridView runat="server" RowStyle-Width="100px" ID="Gridview1" CssClass="gridview" width="100%" AllowPaging="true" PagerStyle-HorizontalAlign="Center" PagerStyle-ForeColor="#003366" PageSize="8" PagerSettings-Mode="NextPrevious" PagerStyle-Font-Size="X-Large" OnPageIndexChanging="Gridview1_PageIndexChanging" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" EmptyDataText="No Records !">
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:TemplateField>
                                           <ItemTemplate> 
                                               <asp:Button ID="btnDetails" runat="server" Text="View" ForeColor="White" BackColor="Gray" BorderStyle="None" CommandArgument='<%# Eval("ID") + "," + Eval("Branch") + "," + Eval("Team")+ "," + Eval("Area")+ "," + Eval("DestinationTo")+ "," + Eval("Hub")+ "," + Eval("Warehouse")%>' OnClick="btnDetails_Click"/>
                                           </ItemTemplate>
                                        </asp:TemplateField>--%>
                                    </Columns>
                                </asp:GridView>
