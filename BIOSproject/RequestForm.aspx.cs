...
namespace BIOSproject
{
    public partial class RequestForm : System.Web.UI.Page
    {
        ...
        {
            //String constring = @"Data Source = 172.25.8.134; Initial Catalog = LBC.BIOS; Persist Security Info=True;User ID = lbcbios;Password=lbcbios";
            //SqlConnection sqlCon = new SqlConnection(constring);
            //sqlCon.Open();
            //string query = "select * from SSPRequest where TicketNo = '" + TicketNo.Text + "' ";
            //SqlCommand sqlCMD = new SqlCommand(query, sqlCon);
            //SqlDataReader sqlDR = sqlCMD.ExecuteReader();
            //while (sqlDR.Read())
            //{
            //    if (Convert.ToInt64(sqlDR["TicketNo"]) == Convert.ToInt64(TicketNo.Text))
            //    {
            //        lblError1.Text = "TicketNo Already Exists!!";
            //    }
            //    else
            //    {
            //        lblError1.Text = "ashdjasdhjhad";
            //    }
            //}
