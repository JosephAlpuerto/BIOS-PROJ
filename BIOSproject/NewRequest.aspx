        ...
        <formview action="#">
            <div class="form-details">
                <div class="input-box2">
                    ...
                    <asp:TextBox ID="TicketNo" runat="server" CssClass="input1" AccessKey="1" ClientIDMode="Static"></asp:TextBox><asp:Label ID="lblerrorTicket" runat="server" ForeColor="Red" CssClass="label"></asp:Label>
                </div>
