...
namespace BIOSproject
{
    public partial class WareHouseform : System.Web.UI.Page
    {
        ...
        protected void txtSeries_TextChanged(object sender, EventArgs e)
        {
            ...
            if(txtSeries.Text != "")
            {
                SqlCommand cmd = new SqlCommand("Select ID, EndingSeries, ProductQuantity, StartingSeries From SSPNewRequest Where  StartingSeries = @Series and DestinationTo = 'Warehouse' and WHcheck = '1' and ifFinish = '1' or  EndingSeries = @Series and DestinationTo = 'Warehouse' and WHcheck = '1' and ifFinish = '1'", sqlCon);
