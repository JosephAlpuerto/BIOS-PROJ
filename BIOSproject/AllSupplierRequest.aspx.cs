    ...
    public partial class AllSupplierRequest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sqlCon.Open();
                SqlCommand cmd = new SqlCommand("Select FirstName, SupplierName From Users Where Username = @Username", sqlCon);
                cmd.Parameters.AddWithValue("@Username", Session["Username"].ToString());
                SqlDataReader dr = cmd.ExecuteReader();
                if (dr.Read())
                {
                    hfName.Value = dr.GetString(0).ToString();
                    hfSuppName.Value = dr.GetString(1).ToString();
                }
                sqlCon.Close();
                FillGridView();
            }
        ...
        void FillGridView()
        {
            ...
            if (sqlCon.State == ConnectionState.Closed)
                sqlCon.Open();
            SqlDataAdapter sqlData = new SqlDataAdapter("[lbcbios].[SSPRequestSupplierShow]", sqlCon);
            sqlData.SelectCommand.CommandType = CommandType.StoredProcedure;
            sqlData.SelectCommand.Parameters.AddWithValue("@Supplier", hfSuppName.Value);
        ...
        public void dl()
        {
            long start = Convert.ToInt64(hfStartdl.Value);
            long end = Convert.ToInt64(hfEnddl.Value);
            string series = "";
            if (hfIDdl.Value != "")
            {
        ...
        protected void btnDL_Click(object sender, EventArgs e)
        {
            ...
            if (sqlCon.State == ConnectionState.Closed)
                sqlCon.Open();
            SqlCommand sqlCmd = new SqlCommand("[lbcbios].[IfPrint]", sqlCon);
            sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void HitCheck_Click(object sender, EventArgs e)
        {
            ...
            if (sqlCon.State == ConnectionState.Closed)
                sqlCon.Open();
            SqlDataAdapter sqlData = new SqlDataAdapter("[lbcbios].[CheckDuplicate]", sqlCon);
            sqlData.SelectCommand.CommandType = CommandType.StoredProcedure;
            ...
            if (sdr.Read())
            {
                ...
                if (sqlCon2.State == ConnectionState.Closed)
                    sqlCon2.Open();
                SqlCommand sqlCmd = new SqlCommand("[lbcbios].[CheckDuplicate2]", sqlCon2);
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void ScanSupplier_Click(object sender, EventArgs e)
        {
            ...
            if (sqlCon3.State == ConnectionState.Closed)
                sqlCon3.Open();
            SqlDataAdapter sqlData3 = new SqlDataAdapter("[lbcbios].[ViewAllByIdSSPRequest]", sqlCon3);
        ...
        public void Hitcheck()
        {
            ...
            if (sdr.Read())
            {
                ...
                if (sqlCon2.State == ConnectionState.Closed)
                    sqlCon2.Open();
                SqlCommand sqlCmd = new SqlCommand("[lbcbios].[OnProduction]", sqlCon2);
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void btnCheck_Click(object sender, EventArgs e)
        {
            ...
            if (hfIdHIT.Value == "")
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("Select EndingSeries, ProductQuantity From [LBC.BIOS].[lbcbios].[SSPNewRequest] Where  StartingSeries = @StartingSeries and Supplier = @Supplier and ID = @ID", sqlCon3);
                    cmd.Parameters.AddWithValue("@StartingSeries", Convert.ToInt64(txtStartScan.Text));
                    ...
                    if (dr.Read())
                    {
                        ...
                        {
                            long start = Convert.ToInt64(txtStartScan.Text);
                            long end = Convert.ToInt64(txtEndScan.Text);
        ...
        //        cmd.Parameters.AddWithValue("@StartingSeries", Convert.ToInt64(txtStartingScan.Text));
        //        cmd.Parameters.AddWithValue("@Supplier", Session["Username"].ToString());
